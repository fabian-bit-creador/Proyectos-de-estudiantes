...
| [Pymedigital](pymedigital/) | Administración | — | Alfabetización digital para pymes de La Pintana. Se unieron las dos páginas en un archivo, se cerró la inyección de HTML del catálogo, se quitaron Google Fonts y un botón de Google que nunca funcionó, y el diagnóstico pasó de dar consejos fijos a señalar las dos preguntas peor contestadas. |
